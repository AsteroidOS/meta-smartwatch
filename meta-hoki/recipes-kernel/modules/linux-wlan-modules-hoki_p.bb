SUMMARY = "External WLAN module for hoki"
LICENSE = "ISC"
...
SRC_URI = " git://android.googlesource.com/kernel/msm-modules/wlan;branch=android-msm-hoki-4.9-pie-wear-mr2;protocol=https \
