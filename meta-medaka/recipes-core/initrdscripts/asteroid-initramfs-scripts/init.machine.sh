...
startadbd() {
    ...
    echo CASIO > /sys/kernel/config/usb_gadget/g1/strings/0x409/manufacturer
    echo WSD-F21HR INITRD > /sys/kernel/config/usb_gadget/g1/strings/0x409/product
...
mount -t auto -o ro /dev/mmcblk0p2 $BOOT_DIR/boot
